...
- For every document creation, update, or review, append an `実行記録` row with the actual start datetime, end datetime, elapsed duration, and actor. Do not overwrite prior rows or infer missing historical times.
