...
- At the start of every document creation, update, or review, record the actual start datetime in that document's `実行記録`. At the end, record the actual end datetime and elapsed duration. Append a row instead of overwriting prior records.
